...
const IndexPage = ({
  ...
  }, "Welcome to My Blog"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-2xl max-w-2xl mx-auto leading-relaxed text-center"
  }, "Discover expert insights and practical strategies to help you make informed financial decisions and achieve your money goals."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(framer_motion__WEBPACK_IMPORTED_MODULE_4__.motion.div, {
    initial: {
      opacity: 0,
      y: 20
    },
  ...
  }, "Start Reading"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: "/about",
    className: "px-10 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold hover:shadow-xl transition-all duration-300 hover:scale-105"
  }, "Learn More"))));
};
const query = "1893900385";
