...
var React = _interopRequireWildcard(__webpack_require__(2503));
...
var _scrollHandler = __webpack_require__(3215);
var _react = __webpack_require__(2503);
...
var _react = _interopRequireDefault(__webpack_require__(2503));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-about-js":()=>Promise.all(/* import() | component---src-pages-about-js */[__webpack_require__.e(855), __webpack_require__.e(432)]).then(__webpack_require__.bind(__webpack_require__, 7053)),"component---src-pages-blog-js":()=>Promise.all(/* import() | component---src-pages-blog-js */[__webpack_require__.e(855), __webpack_require__.e(711)]).then(__webpack_require__.bind(__webpack_require__, 4151)),"component---src-pages-contact-js":()=>Promise.all(/* import() | component---src-pages-contact-js */[__webpack_require__.e(855), __webpack_require__.e(209)]).then(__webpack_require__.bind(__webpack_require__, 5351)),"component---src-pages-index-js":()=>Promise.all(/* import() | component---src-pages-index-js */[__webpack_require__.e(855), __webpack_require__.e(293)]).then(__webpack_require__.bind(__webpack_require__, 9639)),"component---src-templates-blog-post-js":()=>Promise.all(/* import() | component---src-templates-blog-post-js */[__webpack_require__.e(855), __webpack_require__.e(640), __webpack_require__.e(751)]).then(__webpack_require__.bind(__webpack_require__, 6039))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'gatsby-plugin-google-gtag',plugin:__webpack_require__(222),options:{"plugins":[],"trackingIds":["G-XXXXXXXXXX"],"gtagConfig":{}}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(9672),options:{"plugins":[],"output":"/sitemap","exclude":["/404","/404.html","/dev-404-page"],"createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
var external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_);
// EXTERNAL MODULE: ./node_modules/@gatsbyjs/reach-router/dist/index.modern.mjs
var index_modern = __webpack_require__(6462);
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Users_Jeffrey_wheeler_Desktop_blog_my_blog_website_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
...
const React=__webpack_require__(2503);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(7481);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(2503));var _gatsby=__webpack_require__(123);var _path=__webpack_require__(2003);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2503);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(2503),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
var React = __webpack_require__(2503);
...
"use strict";
module.exports = require("C:\\Users\\Jeffrey.wheeler\\Desktop\\blog\\my-blog-website\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\Jeffrey.wheeler\\Desktop\\blog\\my-blog-website\\node_modules\\react-dom\\server.js");
...
/******/ 			return "" + ({"125":"component---src-pages-404-js","209":"component---src-pages-contact-js","293":"component---src-pages-index-js","432":"component---src-pages-about-js","711":"component---src-pages-blog-js","751":"component---src-templates-blog-post-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(2503);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(7481);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(7818);const{WritableAsPromise}=__webpack_require__(5297);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
